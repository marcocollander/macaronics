        ...
        <div className='perfect-occasions'>
            ...
            <div className='perfect-message'>
                ...
                <p>
                    ...
                    Nisi cum repellendus reiciendis tempora unde corrupti, est
                    delectus, laudantium quae a voluptatibus quam natus quaerat!
                    Optio quia assumenda alias deleniti neque?
                </p>
            </div>
        </div>
    );
